...
extern "C" {
#endif
    extern void initPin(unit8_t pin);
    extern void setMode(unit8_t pin, unit8_t mode);
    extern void setValue(unit8_t pin, unit8_t value);

    extern unit8_t getMode(unit8_t pin);
    extern unit8_t getValue(unit8_t pin);
#ifdef __cplusplus
}
#endif
